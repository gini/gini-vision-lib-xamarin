...
#ifndef GINIVISION_SWIFT_H
#define GINIVISION_SWIFT_H
...
- (nonnull instancetype)initWithExtractions:(NSDictionary<NSString *, Extraction *> * _Nonnull)extractions images:(NSArray<UIImage *> * _Nonnull)images candidates:(NSDictionary<NSString *, NSArray<Candidate *> *> * _Nonnull)candidates OBJC_DESIGNATED_INITIALIZER;
...
/// Could not open the document (data could not be read or unsupported file type or some other issue)
  FilePickerErrorFailedToOpenDocument = 3,
};
static NSString * _Nonnull const FilePickerErrorDomain = @"GiniVision.FilePickerError";


/// The <code>GiniColor</code> class allows to customize color for the light and the dark modes.
SWIFT_CLASS("_TtC10GiniVision9GiniColor")
@interface GiniColor : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// note:
/// Screen API only.
@property (nonatomic, strong) UIColor * _Nonnull backgroundColor SWIFT_UNAVAILABLE_MSG("Use the screen specific background color instead e.g. onboardingScreenBackgroundColor");
...
@property (nonatomic, strong) UIColor * _Nonnull cameraSetupLoadingIndicatorColor;
...
@property (nonatomic, strong) UIColor * _Nonnull unsupportedQrCodePopupButtonColor;
/// Sets the text color of the unsupported QR Code popup
@property (nonatomic, strong) GiniColor * _Nonnull unsupportedQrCodePopupTextColor;
/// Sets the  background color of the unsupported QR Code popup
@property (nonatomic, strong) GiniColor * _Nonnull unsupportedQrCodePopupBackgroundColor;
